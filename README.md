...
This software is part of a set of libraries and programs, all under the terms of the MIT License. A partial list of related libraries and programs consists of:
